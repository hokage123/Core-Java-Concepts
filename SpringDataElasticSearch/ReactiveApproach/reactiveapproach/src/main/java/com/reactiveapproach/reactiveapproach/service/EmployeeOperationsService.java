package com.reactiveapproach.reactiveapproach.service;

import com.reactiveapproach.reactiveapproach.entities.Employee;
...
public class EmployeeOperationsService {
    ...
    {
        elasticsearchOperations.delete(String.valueOf(employeeId), Employee.class);
    }
    ...
    public List<Employee> getEmployeesUsingScroll()
    {
